...
void BSP_CAN_InitConfig(void)
{
    ...
    CAN_InitStruct.CAN_BS2         = CAN_BS2_4tq; //CAN BaudRate 42/(1+9+4)/3=1Mbps 36 «103æß’Ò
    ...
    CAN_ITConfig(CAN1,CAN_IT_TME,ENABLE);
		//CAN2Ω” ’÷–∂œ
    CAN_ITConfig(CAN2,CAN_IT_FMP0,ENABLE);  //≤ª–¥CAN2Ω” ’÷–∂œ∑˛ŒÒ∫Ø ˝£¨ª·À¿‘⁄÷–∂œ¿Ô
    CAN_ITConfig(CAN2,CAN_IT_TME,ENABLE); //CAN2∑¢ÀÕ÷–∂
}
